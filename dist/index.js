...
app.use(express_1.default.static(path_1.default.join(__dirname, "process.env.FRONTEND_URL/dist")));
...
app.get("*", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "process.env.FRONTEND_URL/dist/index.html"));
});
app.listen(7000, () => {
